...
class GalleriesController extends BaseController {
    ...
    public function update($id) {
        ...
        **/
        ...
        if ($validator->passes()) {
            ...
            $galleries = Gallery::where('id', '=', $id)->update($input);
    ...
    public function delete($id) {
        ...
        if ($id) {
            $articles = Gallery::where('id', '=', $id)->delete();
            $format = Input::get('format','json');
            if ($articles) {
                $response = array(
                        'header' => array(
    ...
    public function lists() {
        ...
        $galleries = Gallery::skip($offset)->take($limit)->get($fields)->toArray();
        $status['code'] = 200;
    ...
    public function listId($id) {
        ...
        $galleries = Gallery::where('id','=', $id)->get($fields)->toArray();
        // $status['code'] = 200;
        // $status['message'] = 'success';
    ...
    public function content($content_type,$content_id) {
        ...
        $galleries = Gallery::where('content_id','=',$content_id)
